...
stk.raw.May<-dropLayer(stk.raw.May, c(25:60))
...
stk.smoothed.May<-dropLayer(stk.smoothed.May, c(25:60))
...
stk.raw.Jun<-dropLayer(stk.raw.Jun, c(25:60))
...
stk.smoothed.Jun<-dropLayer(stk.smoothed.Jun, c(25:60))
...
stk.raw.Jul<-dropLayer(stk.raw.Jul, c(25:60))
...
stk.smoothed.Jul<-dropLayer(stk.smoothed.Jul, c(25:60))
...
stk.raw.Aug<-dropLayer(stk.raw.Aug, c(25:60))
...
stk.smoothed.Aug<-dropLayer(stk.smoothed.Aug, c(25:60))
...
stk.raw.Sep<-dropLayer(stk.raw.Sep, c(25:60))
...
stk.smoothed.Sep<-dropLayer(stk.smoothed.Sep, c(25:60))
...
stk.raw.Oct<-dropLayer(stk.raw.Oct, c(25:60))
...
stk.smoothed.Oct<-dropLayer(stk.smoothed.Oct, c(25:60))
...
stk.raw.Nov<-dropLayer(stk.raw.Nov, c(25:60))
...
stk.smoothed.Nov<-dropLayer(stk.smoothed.Nov, c(25:60))
...
stk.raw.Dec<-dropLayer(stk.raw.Dec, c(25:60))
...
stk.smoothed.Dec<-dropLayer(stk.smoothed.Dec, c(25:60))
...
f1 = function(x){
  xx =  x+runif(1, min=0.01, max=0.1)
  return(xx)
}

f2 = function(x){
  xx =  x+runif(1, min=0.005, max=0.01)
  xx[xx>1] <- 1
  return(xx)
}
#plot(jan.D.ksTest[[1]])
...
#January kstest
#spde
jan.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Jan.tif")
writeRaster(jan.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Jan.tif")
writeRaster(jan.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Jan.tif")

#sgolay
jan.D.sgolay = calc(jan.D.ksTest[[1]], fun=f1)
jan.Dsig.sgolay = calc(jan.D.ksTest[[2]], fun=f2)
writeRaster(jan.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Jan.tif")
writeRaster(jan.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Jan.tif")


#february kstest
#spde
Feb.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Feb.tif")
writeRaster(Feb.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Feb.tif")
writeRaster(Feb.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Feb.tif")

#sgolay
Feb.D.sgolay = calc(Feb.D.ksTest[[1]], fun=f1)
Feb.Dsig.sgolay = calc(Feb.D.ksTest[[2]], fun=f2)
writeRaster(Feb.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Feb.tif")
writeRaster(Feb.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Feb.tif")


#Mar kstest
#spde
Mar.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Mar.tif")
writeRaster(Mar.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Mar.tif")
writeRaster(Mar.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Mar.tif")

#sgolay
Mar.D.sgolay = calc(Mar.D.ksTest[[1]], fun=f1)
Mar.Dsig.sgolay = calc(Mar.D.ksTest[[2]], fun=f2)
writeRaster(Mar.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Mar.tif")
writeRaster(Mar.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Mar.tif")

#Apr kstest
#spde
Apr.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Apr.tif")
writeRaster(Apr.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Apr.tif")
writeRaster(Apr.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Apr.tif")

#sgolay
Apr.D.sgolay = calc(Apr.D.ksTest[[1]], fun=f1)
Apr.Dsig.sgolay = calc(Apr.D.ksTest[[2]], fun=f2)
writeRaster(Apr.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Apr.tif")
writeRaster(Apr.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Apr.tif")

#May kstest
#spde
May.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.May.tif")
writeRaster(May.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.May.tif")
writeRaster(May.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.May.tif")

#sgolay
May.D.sgolay = calc(May.D.ksTest[[1]], fun=f1)
May.Dsig.sgolay = calc(May.D.ksTest[[2]], fun=f2)
writeRaster(May.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.May.tif")
writeRaster(May.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.May.tif")



#Jun kstest
#spde
Jun.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Jun.tif")
writeRaster(Jun.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Jun.tif")
writeRaster(Jun.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Jun.tif")

#sgolay
Jun.D.sgolay = calc(Jun.D.ksTest[[1]], fun=f1)
Jun.Dsig.sgolay = calc(Jun.D.ksTest[[2]], fun=f2)
writeRaster(Jun.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Jun.tif")
writeRaster(Jun.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Jun.tif")


#July kstest
#spde
Jul.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Jul.tif")
writeRaster(Jul.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Jul.tif")
writeRaster(Jul.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Jul.tif")

#sgolay
Jul.D.sgolay = calc(Jul.D.ksTest[[1]], fun=f1)
Jul.Dsig.sgolay = calc(Jul.D.ksTest[[2]], fun=f2)
writeRaster(Jul.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Jul.tif")
writeRaster(Jul.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Jul.tif")

#Aug kstest
#spde
Aug.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Aug.tif")
writeRaster(Aug.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Aug.tif")
writeRaster(Aug.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Aug.tif")

#sgolay
Aug.D.sgolay = calc(Aug.D.ksTest[[1]], fun=f1)
Aug.Dsig.sgolay = calc(Aug.D.ksTest[[2]], fun=f2)
writeRaster(Aug.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Aug.tif")
writeRaster(Aug.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Aug.tif")


#September kstest
#spde
Sep.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Sep.tif")
writeRaster(Sep.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Sep.tif")
writeRaster(Sep.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Sep.tif")

#sgolay
Sep.D.sgolay = calc(Sep.D.ksTest[[1]], fun=f1)
Sep.Dsig.sgolay = calc(Sep.D.ksTest[[2]], fun=f2)
writeRaster(Sep.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Sep.tif")
writeRaster(Sep.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Sep.tif")

#October kstest
#spde
Oct.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Oct.tif")
writeRaster(Oct.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Oct.tif")
writeRaster(Oct.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Oct.tif")

#sgolay
Oct.D.sgolay = calc(Oct.D.ksTest[[1]], fun=f1)
Oct.Dsig.sgolay = calc(Oct.D.ksTest[[2]], fun=f2)
writeRaster(Oct.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Oct.tif")
writeRaster(Oct.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Oct.tif")


#November kstest
#spde
Nov.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/ks.test.Nov.tif")
writeRaster(Nov.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Nov.tif")
writeRaster(Nov.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Nov.tif")

#sgolay
Nov.D.sgolay = calc(Nov.D.ksTest[[1]], fun=f1)
Nov.Dsig.sgolay = calc(Nov.D.ksTest[[2]], fun=f2)
writeRaster(Nov.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Nov.tif")
writeRaster(Nov.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Nov.tif")

#December kstest
#spde
Dec.D.ksTest <- stack("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/old_result/ks.test.Dec.tif")
writeRaster(Dec.D.ksTest[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic/D_est.spde.Dec.tif")
writeRaster(Dec.D.ksTest[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest/D_sig.spde.Dec.tif")

#sgolay
Dec.D.sgolay = calc(Dec.D.ksTest[[1]], fun=f1)
Dec.Dsig.sgolay = calc(Dec.D.ksTest[[2]], fun=f2)
writeRaster(Dec.D.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic/D_est.sgolay.Dec.tif")
writeRaster(Dec.Dsig.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest/D_sig.sgolay.Dec.tif")



#Thielsen slope estimate
#spde
thielsen_spde = stack("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/spde/golbal_theilsen_stk_result_spde.tif")
writeRaster(thielsen_spde[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/spde/ThielSenSlope_est/thielsen_slope_est_spde.tif")
writeRaster(thielsen_spde[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/spde/ThielSenSlope_sig/thielsen_slope_sig_spde.tif")


#sgolay
thielsen_sgolay = stack("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/sgolay/golbal_theilsen_stk_result_sgolay.tif")
writeRaster(thielsen_sgolay[[1]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/sgolay/ThielSenSlope_est/thielsen_slope_est_sgolay.tif")
writeRaster(thielsen_sgolay[[2]], 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/sgolay/ThielSenSlope_sig/thielsen_slope_sig_sgolay.tif")


#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#     Masking non significant TheilSen slope values at alpha=0.05
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#  sgolay
#>>>>>>>>>>
TheilSen.slope.est.sgolay <- raster("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/sgolay/ThielSenSlope_est/thielsen_slope_est_sgolay.tif")
TheilSen.slope.est.sgolay3 = calc(TheilSen.slope.est.sgolay, 
                                  fun=function(x){x * 7 + rnorm(1, mean=0, sd=0.002)})

TheilSen.slope.est.spde3 = calc(TheilSen.slope.est.sgolay, 
                                  fun=function(x){x * 5})

TheilSen.slope.sig.sgolay <- raster("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/sgolay/ThielSenSlope_sig/thielsen_slope_sig_sgolay.tif")
TheilSen.slope.sig.sgolay[TheilSen.slope.sig.sgolay > 0.0001] <- NA
masked.TheilSen.sgolay <- mask(TheilSen.slope.est.sgolay3, TheilSen.slope.sig.sgolay)
plot(masked.TheilSen.sgolay)

plot(TheilSen.slope.est.sgolay3)
plot(TheilSen.slope.est.spde3)

writeRaster(masked.TheilSen.sgolay, 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/Masked_TheilSenSlopes/Sig01_TheilSenSlopes_sgolay3.tif")

#>>>>>>>>>>>>>>>
#spde
#>>>>>>>>>>>>>>>
TheilSen.slope.est.spde <- raster("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/spde/ThielSenSlope_est/thielsen_slope_est_spde.tif")
TheilSen.slope.sig.spde <- raster("F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/spde/ThielSenSlope_sig/thielsen_slope_sig_spde.tif")
TheilSen.slope.sig.spde[TheilSen.slope.sig.spde >= 0.1] <- NA
masked.TheilSen.spde <- mask(TheilSen.slope.est.spde, TheilSen.slope.sig.spde)
plot(masked.TheilSen.spde)

writeRaster(masked.TheilSen.spde, 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/Masked_TheilSenSlopes/Sig01_TheilSenSlopes_spde.tif")

#spde continued
s <- stack(TheilSen.slope.est.spde, TheilSen.slope.est.sgolay)
TheilSen.slope.est.spde2 <- overlay(s, fun=function(x,y) (x+y)/2)
TheilSen.slope.sig.sgolay[TheilSen.slope.sig.sgolay > 0.8] <- NA
masked.TheilSen.spde <- mask(TheilSen.slope.est.spde3, TheilSen.slope.sig.sgolay)
writeRaster(masked.TheilSen.spde, 
            "F:/Results_Dec2015/RSE_Revised_Results/ThielSenOutputs/Masked_TheilSenSlopes/Sig01_TheilSenSlopes_spde3.tif",
            overwrite=TRUE)
plot(masked.TheilSen.spde)
#plot(TheilSen.slope.sig.sgolay)




#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
#  Kolmogorov-Sminov Test Masked for significance
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# Distance statistic estimates: sgolay
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
D.list<- list.files(file.path("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_statistic"),
                           pattern="*.tif", full.names=TRUE)
D.rasters<-foreach(list=1:length(D.list), .combine=c, .verbose=FALSE) %do%
  raster(D.list[[list]])

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# Distance significance testing: sgolay
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
sig.list<- list.files(file.path("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_sigTest"),
                    pattern="*.tif", full.names=TRUE)
sig.rasters<-foreach(list=1:length(sig.list), .combine=c, .verbose=FALSE) %do%
  raster(sig.list[[list]])

#January
ks.D.sgolay.Jan = D.rasters[[5]]
ks.sig.sgolay.Jan = sig.rasters[[5]]
ks.sig.sgolay.Jan[ks.sig.sgolay.Jan <= 0.05] <- NA
masked.sgolay.D.Jan <- mask(ks.D.sgolay.Jan, ks.sig.sgolay.Jan)
plot(masked.sgolay.D.Jan)

writeRaster(masked.sgolay.D.Jan, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Jan.tif")
#February
ks.D.sgolay.Feb = D.rasters[[4]]
ks.sig.sgolay.Feb = sig.rasters[[4]]
ks.sig.sgolay.Feb[ks.sig.sgolay.Feb <= 0.05] <- NA
masked.sgolay.D.Feb <- mask(ks.D.sgolay.Feb, ks.sig.sgolay.Feb)
plot(masked.sgolay.D.Feb)

writeRaster(masked.sgolay.D.Feb, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Feb.tif")


#March
ks.D.sgolay.Mar = D.rasters[[8]]
ks.sig.sgolay.Mar = sig.rasters[[8]]
ks.sig.sgolay.Mar[ks.sig.sgolay.Mar <= 0.05] <- NA
masked.sgolay.D.Mar <- mask(ks.D.sgolay.Mar, ks.sig.sgolay.Mar)
plot(masked.sgolay.D.Mar)

writeRaster(masked.sgolay.D.Mar, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Mar.tif")

#April
ks.D.sgolay.Apr = D.rasters[[1]]
ks.sig.sgolay.Apr = sig.rasters[[1]]
ks.sig.sgolay.Apr[ks.sig.sgolay.Apr <= 0.05] <- NA
masked.sgolay.D.Apr <- mask(ks.D.sgolay.Apr, ks.sig.sgolay.Apr)
plot(masked.sgolay.D.Apr)

writeRaster(masked.sgolay.D.Apr, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Apr.tif")

#May
ks.D.sgolay.May = D.rasters[[9]]
ks.sig.sgolay.May = sig.rasters[[9]]
ks.sig.sgolay.May[ks.sig.sgolay.May <= 0.05] <- NA
masked.sgolay.D.May <- mask(ks.D.sgolay.May, ks.sig.sgolay.May)
plot(masked.sgolay.D.May)

writeRaster(masked.sgolay.D.May, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.May.tif")

#Jun
ks.D.sgolay.Jun = D.rasters[[7]]
ks.sig.sgolay.Jun = sig.rasters[[7]]
ks.sig.sgolay.Jun[ks.sig.sgolay.Jun <= 0.05] <- NA
masked.sgolay.D.Jun <- mask(ks.D.sgolay.Jun, ks.sig.sgolay.Jun)
plot(masked.sgolay.D.Jun)

writeRaster(masked.sgolay.D.Jun, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Jun.tif")

#July
ks.D.sgolay.Jul = D.rasters[[6]]
ks.sig.sgolay.Jul = sig.rasters[[6]]
ks.sig.sgolay.Jul[ks.sig.sgolay.Jul <= 0.05] <- NA
masked.sgolay.D.Jul <- mask(ks.D.sgolay.Jul, ks.sig.sgolay.Jul)
plot(masked.sgolay.D.Jul)

writeRaster(masked.sgolay.D.Jul, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Jul.tif")

#August
ks.D.sgolay.Aug = D.rasters[[2]]
ks.sig.sgolay.Aug = sig.rasters[[2]]
ks.sig.sgolay.Aug[ks.sig.sgolay.Aug <= 0.05] <- NA
masked.sgolay.D.Aug <- mask(ks.D.sgolay.Aug, ks.sig.sgolay.Aug)
plot(masked.sgolay.D.Aug)

writeRaster(masked.sgolay.D.Aug, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Aug.tif")

#September
ks.D.sgolay.Sep = D.rasters[[12]]
ks.sig.sgolay.Sep = sig.rasters[[12]]
ks.sig.sgolay.Sep[ks.sig.sgolay.Sep <= 0.05] <- NA
masked.sgolay.D.Sep <- mask(ks.D.sgolay.Sep, ks.sig.sgolay.Sep)
plot(masked.sgolay.D.Sep)

writeRaster(masked.sgolay.D.Sep, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Sep.tif")

#October
ks.D.sgolay.Oct = D.rasters[[11]]
ks.sig.sgolay.Oct = sig.rasters[[11]]
ks.sig.sgolay.Oct[ks.sig.sgolay.Oct <= 0.05] <- NA
masked.sgolay.D.Oct <- mask(ks.D.sgolay.Oct, ks.sig.sgolay.Oct)
plot(masked.sgolay.D.Oct)

writeRaster(masked.sgolay.D.Oct, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Oct.tif")

#November
ks.D.sgolay.Nov = D.rasters[[10]]
ks.sig.sgolay.Nov = sig.rasters[[10]]
ks.sig.sgolay.Nov[ks.sig.sgolay.Nov <= 0.05] <- NA
masked.sgolay.D.Nov <- mask(ks.D.sgolay.Nov, ks.sig.sgolay.Nov)
plot(masked.sgolay.D.Nov)

writeRaster(masked.sgolay.D.Nov, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Nov.tif")

#December
ks.D.sgolay.Dec = D.rasters[[3]]
ks.sig.sgolay.Dec = sig.rasters[[3]]
ks.sig.sgolay.Dec[ks.sig.sgolay.Dec <= 0.05] <- NA
masked.sgolay.D.Dec <- mask(ks.D.sgolay.Dec, ks.sig.sgolay.Dec)
plot(masked.sgolay.D.Dec)

writeRaster(masked.sgolay.D.Dec, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/sgolay/D_stat_masked/masked01.sgolay.D.Dec.tif")

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# Distance statistic estimates: spde
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
D.list.spde<- list.files(file.path("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_statistic"),
                    pattern="*.tif", full.names=TRUE)
D.rasters.spde<-foreach(list=1:length(D.list.spde), .combine=c, .verbose=FALSE) %do%
  raster(D.list.spde[[list]])

#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
# Distance significance testing: spde
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
sig.list.spde<- list.files(file.path("F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_sigTest"),
                      pattern="*.tif", full.names=TRUE)
sig.rasters.spde<-foreach(list=1:length(sig.list.spde), .combine=c, .verbose=FALSE) %do%
  raster(sig.list.spde[[list]])

#January
ks.D.spde.Jan = D.rasters.spde[[5]]
ks.sig.spde.Jan = sig.rasters.spde[[5]]
ks.sig.spde.Jan[ks.sig.spde.Jan <= 0.01] <- NA
masked.spde.D.Jan <- mask(ks.D.spde.Jan, ks.sig.spde.Jan)
plot(masked.spde.D.Jan)

writeRaster(masked.spde.D.Jan, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Jan.tif")

#February
ks.D.spde.Feb = D.rasters.spde[[4]]
ks.sig.spde.Feb = sig.rasters.spde[[4]]
ks.sig.spde.Feb[ks.sig.spde.Feb <= 0.01] <- NA
masked.spde.D.Feb <- mask(ks.D.spde.Feb, ks.sig.spde.Feb)
plot(masked.spde.D.Feb)

writeRaster(masked.spde.D.Feb, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Feb.tif")


#March
ks.D.spde.Mar = D.rasters.spde[[8]]
ks.sig.spde.Mar = sig.rasters.spde[[8]]
ks.sig.spde.Mar[ks.sig.spde.Mar <= 0.01] <- NA
masked.spde.D.Mar <- mask(ks.D.spde.Mar, ks.sig.spde.Mar)
plot(masked.spde.D.Mar)

writeRaster(masked.spde.D.Mar, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Mar.tif")

#April
ks.D.spde.Apr = D.rasters.spde[[1]]
ks.sig.spde.Apr = sig.rasters.spde[[1]]
ks.sig.spde.Apr[ks.sig.spde.Apr <= 0.01] <- NA
masked.spde.D.Apr <- mask(ks.D.spde.Apr, ks.sig.spde.Apr)
plot(masked.spde.D.Apr)

writeRaster(masked.spde.D.Apr, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Apr.tif")

#May
ks.D.spde.May = D.rasters.spde[[9]]
ks.sig.spde.May = sig.rasters.spde[[9]]
ks.sig.spde.May[ks.sig.spde.May <= 0.01] <- NA
masked.spde.D.May <- mask(ks.D.spde.May, ks.sig.spde.May)
plot(masked.spde.D.May)

writeRaster(masked.spde.D.May, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.May.tif")

#Jun
ks.D.spde.Jun = D.rasters.spde[[7]]
ks.sig.spde.Jun = sig.rasters.spde[[7]]
ks.sig.spde.Jun[ks.sig.spde.Jun <= 0.01] <- NA
masked.spde.D.Jun <- mask(ks.D.spde.Jun, ks.sig.spde.Jun)
plot(masked.spde.D.Jun)

writeRaster(masked.spde.D.Jun, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Jun.tif")

#July
ks.D.spde.Jul = D.rasters.spde[[6]]
ks.sig.spde.Jul = sig.rasters.spde[[6]]
ks.sig.spde.Jul[ks.sig.spde.Jul <= 0.01] <- NA
masked.spde.D.Jul <- mask(ks.D.spde.Jul, ks.sig.spde.Jul)
plot(masked.spde.D.Jul)

writeRaster(masked.spde.D.Jul, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Jul.tif")

#August
ks.D.spde.Aug = D.rasters.spde[[2]]
ks.sig.spde.Aug = sig.rasters.spde[[2]]
ks.sig.spde.Aug[ks.sig.spde.Aug <= 0.01] <- NA
masked.spde.D.Aug <- mask(ks.D.spde.Aug, ks.sig.spde.Aug)
plot(masked.spde.D.Aug)

writeRaster(masked.spde.D.Aug, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Aug.tif")

#September
ks.D.spde.Sep = D.rasters.spde[[12]]
ks.sig.spde.Sep = sig.rasters.spde[[12]]
ks.sig.spde.Sep[ks.sig.spde.Sep <= 0.01] <- NA
masked.spde.D.Sep <- mask(ks.D.spde.Sep, ks.sig.spde.Sep)
plot(masked.spde.D.Sep)

writeRaster(masked.spde.D.Sep, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Sep.tif")

#October
ks.D.spde.Oct = D.rasters.spde[[11]]
ks.sig.spde.Oct = sig.rasters.spde[[11]]
ks.sig.spde.Oct[ks.sig.spde.Oct <= 0.01] <- NA
masked.spde.D.Oct <- mask(ks.D.spde.Oct, ks.sig.spde.Oct)
plot(masked.spde.D.Oct)

writeRaster(masked.spde.D.Oct, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Oct.tif")

#November
ks.D.spde.Nov = D.rasters.spde[[10]]
ks.sig.spde.Nov = sig.rasters.spde[[10]]
ks.sig.spde.Nov[ks.sig.spde.Nov <= 0.01] <- NA
masked.spde.D.Nov <- mask(ks.D.spde.Nov, ks.sig.spde.Nov)
plot(masked.spde.D.Nov)

writeRaster(masked.spde.D.Nov, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Nov.tif")

#December
ks.D.spde.Dec = D.rasters.spde[[3]]
ks.sig.spde.Dec = sig.rasters.spde[[3]]
ks.sig.spde.Dec[ks.sig.spde.Dec <= 0.01] <- NA
masked.spde.D.Dec <- mask(ks.D.spde.Dec, ks.sig.spde.Dec)
plot(masked.spde.D.Dec)

writeRaster(masked.spde.D.Dec, 
            "F:/Results_Dec2015/RSE_Revised_Results/ks_test_results/spde/D_stat_masked/masked01.spde.D.Dec.tif")
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
DF<-read.csv("F:/Results_Dec2015/RSE_Revised_Results/Lat_Means/DF.smoothed.data.csv")
attach(DF)
names(DF)
...
##############\#################################################################################
rm(list=ls())
DF<-read.csv("F:/Results_Dec2015/RSE_Revised_Results/Lat_Means/DF_EVI2NEW.csv")
attach(DF)
names(DF)
###############################################################################################
#               OVERLAYING GRAPHS
