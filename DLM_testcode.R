...
##############################################################
#a_t related to green up/peak
#############################################################
est.amplitude=r$summary.random[[1]][1:p,c("mean","sd","0.025quant","0.95quant")]
mean.amplitude=mean(r$summary.random[[1]][1:p,"mean"])
sd.amplitude=sd(r$summary.random[[1]][1:p,"mean"])

############################################################
#b_t related to seasonal length; low minimum phase might signify delay in the onset
#############################################################
est.phase=r$summary.random[[2]][2:p,c("mean","sd","0.025quant","0.95quant")]
mean.phase=mean(r$summary.random[[2]][2:p,"mean"])
sd.phase=sd(r$summary.random[[2]][2:p,"mean"])
max.phase=max(r$summary.random[[2]][2:p,"mean"])
min.phase=min(r$summary.random[[2]][2:p,"mean"])
season.length=max.phase-min.phase
