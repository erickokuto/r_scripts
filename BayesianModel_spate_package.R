...
DRC_EVI2_record<-read.dta("F:/CLIM_DATA/DRC_EVI2_Unsmoothed_Records/DRC_Database/DRC_EVI_Monthly_Data_Wide.dta")
dim(DRC_EVI2_record)

DRC_EVI2_record2<-as.matrix(DRC_EVI2_record[,-(1:2)])
DRC_EVI2_record4<-DRC_EVI2_record2[1:5,1:5]
dim(DRC_EVI2_record2)
DRC_EVI2_record3 <- t(DRC_EVI2_record2)
dim(DRC_EVI2_record3)
DRC_EVI2_record2[1:100,]

# DRC_EVI2_record_Test<-DRC_EVI2_record[1:10,]
# w=as.matrix(DRC_EVI2_record_Test)

####################
# The SPDE MODEL
######################
spateMCMC <- spate.mcmc(y=DRC_EVI2_record4,x=NULL,coord=as.matrix(DRC_EVI2_record[1:5,1:2]),
                        SV=c(rho0=0.2,sigma2=0.1,
                        ...
                        Nmc=10000,BurnIn=2000,seed=4,NCovEst=500, DimRed=TRUE,
                        NFour=29,
                        IncidenceMat=TRUE,
                        BurnInCovEst=500,trace=FALSE,Padding=TRUE,
                        path=NULL,
                        file=NULL,
                        n=5,
                        saveProcess=FALSE,
...
spateMCMC <- spate.mcmc(y=y,x=NULL,DataModel="normal",Sind=NULL,
